...
mydb=pymysql.connect(host='localhost', user='root', password='', port=3307, database='smart_voting_system')

sender_address = 'rajasekharraj91295@gmail.com' #enter sender's email id
sender_pass = 'cirnhjbjjminvsve' #enter sender's passwor
...
def add_nominee():
    if request.method=='POST':
        ...
        if member in all_members:
            ...
            mydb.commit()
            cur.close()
            flash(r"Successfully registered a new subject", 'primary')
...
def select_candidate():
    ...
    if aadhar in all_adhar:
        ...
        if request.method == 'POST':
            ...
            #
            # headers = {
            #     "authorization": "ujX1Y5qsiUpOCT4mS3eQnAPLHRrc0FMdlVKwzbgfGtxBohy97IeGMOTfRi68VYhU5HjatIn7skrzm4J9",
